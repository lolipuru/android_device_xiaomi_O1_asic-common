...
PRODUCT_SHIPPING_API_LEVEL := 202424
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.bluetooth_le.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/etc/permissions/android.hardware.bluetooth_le.xml
